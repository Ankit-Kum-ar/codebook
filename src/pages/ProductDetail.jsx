    ...
    return (
        <main>
            ...
            <div className="flex flex-wrap justify-around">
                ...
                <p className="my-4 select-none flex flex-wrap gap-2">
                    <span className="font-semibold text-amber-500 border bg-amber-50 rounded-lg px-3 py-1 ">BEST SELLER</span> 
                    <span className="font-semibold text-emerald-600	border bg-slate-100 rounded-lg px-3 py-1 ">INSTOCK</span>
                     <span className="font-semibold text-rose-700 border bg-slate-100 rounded-lg px-3 py-1">OUT OF STOCK</span> 
                    <span className="font-semibold text-blue-500 border bg-slate-100 rounded-lg px-3 py-1">{product.size} MB</span>
                </p>
                <p className="my-7">
